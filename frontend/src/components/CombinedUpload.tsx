            ...
            <div className="grid md:grid-cols-2 gap-10 items-end">
                ...
                <div className="flex flex-col gap-6">
                    <div className="w-full flex justify-center">
                        <div className="flex bg-white/20 backdrop-blur-xl p-1.5 rounded-2xl w-fit border border-white/30 shadow-[0_4px_20px_rgb(0,0,0,0.05)]">
                            <button
                    ...
                    {noticeMode === "file" ? (
                        ...
                        <div className="relative group h-64 rounded-2xl border border-white/30 bg-gradient-to-br from-white/30 to-white/10 backdrop-blur-3xl p-8 flex flex-col items-center justify-center transition-all duration-500 shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:shadow-[0_20px_40px_rgba(79,70,229,0.15)] hover:-translate-y-1 hover:from-white/40 hover:to-white/20 overflow-hidden">
                            ...
                            <div className="relative z-10 w-full flex flex-col items-center">
                                <div className="w-16 h-16 rounded-2xl bg-white/70 backdrop-blur-md text-indigo-600 flex items-center justify-center mb-6 overflow-hidden transition-all duration-500 shadow-sm border border-white/50 group-hover:bg-indigo-600 group-hover:text-white group-hover:border-indigo-600 group-hover:scale-110 group-hover:rotate-6">
                                ...
                                <div className="w-full space-y-4">
                                    ...
                                    <div className="relative w-full">
                                        <input
                                            ...
                                            className="w-full px-8 py-5 rounded-xl border border-white/40 bg-white/50 backdrop-blur-lg focus:bg-white/80 focus:border-indigo-400 focus:outline-none transition-all font-black text-sm text-slate-700 shadow-sm placeholder:text-slate-500"
                                        />
...
function FileBox({ title, file, setFile, icon, color }: {
    ...
    return (
        <div
            className={`relative group h-64 rounded-2xl border border-white/30 transition-all duration-500 overflow-hidden flex flex-col items-center justify-center bg-gradient-to-br from-white/30 to-white/10 backdrop-blur-3xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] ${dragActive
